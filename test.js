...
test('var by default', () => {
  ...
  expect(document.getElementById('listProducts').innerHTML).toBe(
    '<li><span class="productName">Flour of corn</span><span class="productQuantity">1</span><span class="productOpts">delivered</span><span class="productPrice">12.12</span></li>'
  );
