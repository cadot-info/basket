...
test('var by default', () => {
  ...
  expect(document.getElementById('totalPriceProducts').textContent).toBe("12.12");
    expect(document.getElementById('listProducts').innerHTML).toBe("<li><span class=\"productName\">Flour of corn</span><span class=\"productQuantity\">1</span><span class=\"productOpts\"></span><span class=\"productPrice\">12.12</span></li>");
  ...
  expect(document.getElementById('nbrTotalProducts').textContent).toBe("1");
  expect(document.getElementById('listProducts').innerHTML).toBe("<li><span class=\"productName\">Flour of corn</span><span class=\"productQuantity\">2</span><span class=\"productOpts\"></span><span class=\"productPrice\">24.24</span></li>");
 ...
 expect(document.getElementById('listProducts').innerHTML).toBe("<li><span class=\"productName\">Flour of corn</span><span class=\"productQuantity\">2</span><span class=\"productOpts\"></span><span class=\"productPrice\">24.24</span></li><li><span class=\"productName\">wine bordeaux 2016</span><span class=\"productQuantity\">1</span><span class=\"productOpts\"></span><span class=\"productPrice\">1.11</span></li>");
 ...
 expect(document.getElementById('nbrProducts').textContent).toBe("2");
 expect(document.getElementById('nbrTotalProducts').textContent).toBe("2");
 expect(document.getElementById('listProducts').innerHTML).toBe("<li><span class=\"productName\">Flour of corn</span><span class=\"productQuantity\">1</span><span class=\"productOpts\"></span><span class=\"productPrice\">12.12</span></li><li><span class=\"productName\">wine bordeaux 2016</span><span class=\"productQuantity\">1</span><span class=\"productOpts\"></span><span class=\"productPrice\">1.11</span></li>");
 ...
 expect(document.getElementById('listProducts').innerHTML).toBe("<li><span class=\"productName\">wine bordeaux 2016</span><span class=\"productQuantity\">1</span><span class=\"productOpts\"></span><span class=\"productPrice\">1.11</span></li>");
